...
namespace InteriorShoppe.Controllers
{
    public class BasketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,BasketID,ProductID,Quantity")] Basket basket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,BasketID,ProductID,Quantity")] Basket basket)
        {
            if (id != basket.ID)
            {
                return NotFound();
